...
/* DSblock model generated by Dymola from Modelica model FM3217_2022.Tuturial3.Tests.DCMachineTest
 Dymola Version 2020 (64-bit), 2019-04-10 translated this at Mon Sep 19 12:49:58 2022
...
#define NHash1_ -501424431
#define NHash2_ 903987732
#define NHash3_ 0
#define NI_    0
#define NRelF_ 0
#define NRel_  0
...
PreNonAliasDef(5)
#if !defined(DYM2CCUR)
 DYMOLA_STATIC const char*modelName="FM3217_2022.Tuturial3.Tests.DCMachineTest";
#endif
...
AssertModelica(1+DYNX(DP_,2)*(DYNX(W_,3)-DYNX(DP_,1)) >= 1E-15,"1+dCMachine.Ra.alpha*(dCMachine.Ra.T-dCMachine.Ra.T_ref) >= 1E-15",
...
SolveScalarLinearParametric(DYNX(DP_,3),"dCMachine.La.L", DYNX(W_,8),
...
SolveScalarLinearParametric(DYNX(DP_,6),"dCMachine.inertia.J",  -DYNX(W_,12),
...
PreNonAliasNew(0)
StartNonAlias(0)
DeclareParameter("dCMachine.Ra.R", "Resistance at temperature T_ref [Ohm]", 0, 1,\
 0.0,0.0,0.0,0,560)
DeclareParameter("dCMachine.Ra.T_ref", "Reference temperature [K|degC]", 1, \
...
DeclareAlias2("dCMachine.Ra.p.v", "Potential at the pin [V]", "dCMachine.p.v", 1,\
 5, 17, 4)
...
"dCMachine.La.i", -1, 1, 0, 132)
DeclareParameter("dCMachine.La.L", "Inductance [H]", 3, 1, 0.0,0.0,0.0,0,560)
